...
const Main1 = () => {
  ...
  return (
        ...
        <div class="w-1/4 border border-black h-screen  shadow-lg shadow-blue-400 ">
                <div className='flex m-2'>
                    ...
                    <p className='cursor-pointer'  onClick={()=>setstate1(!state1)} >Shared Services</p>
                    
                </div>
                {state1&&<p onClick={()=>setstate2(!state2)} className='pl-7 cursor-pointer'>Archive Server</p>}

                {state2&& <div className='flex flex-col ml-12 '>
                    {
                        data.map((d)=>{
